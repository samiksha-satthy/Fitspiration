    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 text-2xl font-serif font-semibold mb-2">
            <Shirt className="h-7 w-7" />
            StyleSync
          </Link>
          <p className="text-muted-foreground text-sm">Start organizing your wardrobe today</p>
        </div>

        <Card>
          <CardHeader>
            <CardTitle className="font-serif text-2xl">Create Account</CardTitle>
            <CardDescription>Get started with your digital wardrobe</CardDescription>
          </CardHeader>
          <CardContent>
